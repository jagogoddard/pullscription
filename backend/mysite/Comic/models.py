...
class Comic(models.Model): # Fields imported from left to right on the original .csv
    ...
    def __str__(self):
        ...
        return "{" + '"diamd_no": ' + '"' + str(self.diamd_no) + '", ' + '"stock_no": ' + '"' + str(self.stock_no) + '", ' + '"full_title": ' + '"' + str(self.full_title) + '", ' + '"main_desc": ' + '"' + str(self.main_desc) + '", ' + '"price": ' + '"' + str(self.price) + '", ' + '"publisher": ' + '"' + str(self.publisher) + '", ' + '"short_isbn_no": ' + '"' + str(self.short_isbn_no) + '", ' + '"prnt_date": ' + '"' + str(self.prnt_date) + '", ' + '"ship_date": ' + '"' + str(self.ship_date) + '", ' + '"writer": ' + '"' + str(self.writer) + '", ' + '"artist": ' + '"' + str(self.artist) + '", ' + '"cover_artist": ' + '"' + str(self.cover_artist) + '", ' + '"colorist": ' + '"' + str(self.colorist) + '", ' + '"number_of_pages": ' + '"' + str(self.number_of_pages) + '"}'
